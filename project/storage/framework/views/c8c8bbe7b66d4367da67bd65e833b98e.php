      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <!-- Logout form chuẩn Laravel -->
            <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" class="d-inline">
              <?php echo csrf_field(); ?>
              <button type="submit" class="btn btn-primary"><?php echo e(__('Logout')); ?></button>
            </form>
...
<?php /**PATH E:\Phanmemhoctap\ThucTapChuyenNganh\project\resources\views/layout/admin.blade.php ENDPATH**/ ?>